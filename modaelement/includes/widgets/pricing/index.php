...
use ModaElement_Elementor_Addons;
    ...
    protected function _register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => ModaElement_Elementor_Addons::LIST_CONTROL,
            ]
        );
        $repeater->add_control(
            'button',
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'pr_fonts',
                'label' => __('Pricing Typography', 'moda'),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'fea_fonts',
                'label' => __('Feature Typography', 'moda'),
        ...
        $this->add_control(
            'btn_hover_color',
            [
                'label' => __('Button Hover Color', 'moda'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            foreach ($settings['price_list'] as $monthly) {
                ...
                echo '<div class="price-box wow fadeInLeft">
                        ...
                        <div class="price-info">
                            <ul>';
                moda_list_control($monthly['features'], '<i class="fas fa-check-circle"></i>');
                echo '</ul>
                        </div>
