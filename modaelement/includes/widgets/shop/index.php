...
class moda_product_shop extends Widget_Base
{

    public function get_name()
    {
        return 'moda-product-shop';
    }

    public function get_title()
    {
        return __('Shop Archive', 'moda');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => __('Product Archive', 'moda'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
            'link1', [
                'label' => __('Link 1', 'moda'),
...
Plugin::instance()->widgets_manager->register(new moda_product_shop());
?>