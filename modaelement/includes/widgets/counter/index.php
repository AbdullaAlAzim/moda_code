...
class moda_counter extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'counter_list',
            [
                'label' => __('Counter List', 'moda'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'title' => __('Happy Clients', 'moda'),
                    ],
                    [
                        'title' => __('Happy Clients', 'moda'),
                    ],
...
Plugin::instance()->widgets_manager->register(new moda_counter());